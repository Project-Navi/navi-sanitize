...
\begin{center}
  ...
  {\small March 2026 \quad\textbullet\quad v0.1.1 \quad\textbullet\quad \texttt{767cc3c}}
\end{center}
...
2 & Invisible strip & Remove 492 chars across eight categories including zero-width, format/control, tag block, bidi, variation selectors, Mongolian FVS, and C0/C1 controls \\
...
The test suite comprises 357 cases across six categories:
